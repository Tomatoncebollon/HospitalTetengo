...
<body>
  <nav class="navbar navbar-expand-md navbar-light bg-faded text-center">
    <div class="container">
      <a class="navbar-brand" href="#">Hospital Tetengo - Secretaría
        <br> </a>
      ...
      <div class="collapse navbar-collapse text-center justify-content-center" id="navbar2SupportedContent">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <div class="btn-group mx-1">
              ...
              <div class="dropdown-menu">
                ...
                <a class="dropdown-item" href="<?php echo base_url('CI_Atencion/consultar') ?>">Atención</a>
                <div class="dropdown-divider"></div>
          ...
          <li class="nav-item">
            <div class="btn-group mx-1">
              ...
              <div class="dropdown-menu">
                ...
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="<?php echo base_url('CI_Atencion/listar') ?>">Atención</a>
                <div class="dropdown-divider"></div>
          ...
          <li class="nav-item">
            <div class="btn-group mx-1">
              <button class="btn dropdown-toggle btn-default" data-toggle="dropdown"> Gestión de Atenciones </button>
              <div class="dropdown-menu">
                <a class="dropdown-item" href="<?php echo base_url('CI_Atencion/agendar') ?>">Agendar Atención</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="<?php echo base_url('CI_Atencion/gestionar') ?>">Gestionar Atención</a>
              </div>
            </div>
          </li>
        </ul>
